...
export declare enum PreOwnedGrade {
    A = "A",
    B = "B",
    C = "C"
}
...
export declare const PAKISTAN_CITIES: readonly ["Karachi", "Lahore", "Islamabad", "Rawalpindi", "Faisalabad", "Multan", "Peshawar", "Quetta", "Hyderabad", "Sialkot", "Gujranwala", "Abbottabad", "Sargodha", "Bahawalpur", "Sukkur"];
export type PakistanCity = (typeof PAKISTAN_CITIES)[number];
export declare const COD_FEE = 150;
